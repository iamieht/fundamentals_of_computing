...
def spawn_ball(direction):
    ...
    ball_vel = [(random.randrange(120/60, 240/60)), (random.randrange(60/60, 180/60)) ] # pixels per second
  
    
    if direction == "RIGHT": # upwards and towards right
        ball_vel[1] = - ball_vel[1] 
    elif direction == "LEFT": # upwards and towards left
